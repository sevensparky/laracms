...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br/>
                <form action="{{ route('faqs.store') }}" method="POST"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea class="form-control col-md-7 col-xs-12" name="question" cols="3" rows="3"
                                      placeholder="عنوان سوال را وارد کنید." style="resize: none"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <div class="x_content">
                                ...
                                <textarea id="descr" name="answer" class="editor-wrapper" style="width: 719px; height: 272px;resize:none"></textarea>
