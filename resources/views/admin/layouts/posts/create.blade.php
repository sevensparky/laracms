        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" id="demo-form2"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <textarea type="text" id="description" class="form-control col-md-7 col-xs-12" name="description" rows="3"
                                    placeholder="توضیحات کوتاهی را وارد کنید..." style="resize: none;">{{ old('description') }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#editor">
                                        ...
                                        <div class="btn-group">
                                            <a class="btn" data-edit="bold" title="درشت (Ctrl/Cmd+B)"><i
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a class="btn" data-edit="indent" title="دنداره (Tab)"><i
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a class="btn" data-edit="unlink" title="حذف ابر لینک"><i
                                                    class="fa fa-cut"></i></a>
                                        </div>
                                    ...
                                    <textarea id="descr" name="content" class="editor-wrapper" style="width: 719px; height: 272px;resize:none"></textarea>
