                   ...
                   @include('admin.layouts.messages.error')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="title" id="title" required="required" value="{{ $post->title }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            class="form-control col-md-7 col-xs-12" name="description" 
                             rows="3" placeholder="توضیحات کوتاهی را وارد کنید...">{{ $post->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            class="form-control col-md-7 col-xs-12" name="content" 
                             rows="7" placeholder="متن مقاله را وارد کنید...">{{ $post->content }}</textarea>
                        </div>
                    </div>
