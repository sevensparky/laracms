...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br/>
                <form action="{{ route('articles.update',$article->slug) }}" method="POST" enctype="multipart/form-data"  id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            class="form-control col-md-7 col-xs-12" name="description" 
                             rows="3" placeholder="توضیحات کوتاهی را وارد کنید...">{{ $article->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            class="form-control col-md-7 col-xs-12" name="body" 
                             rows="7" placeholder="متن مقاله را وارد کنید...">{{ $article->body }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="file" name="images" id="images" value="{{ asset("upload/articles/$article->images") }}" required="required"
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="images">
                        </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <img src="{{ asset("upload/articles/$article->images") }}" width="380" height="280"> 
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input id="tags_1" type="text" name="tags" class="tags form-control" value="{{ $article->tags }}" data-role="tagsinput"/>
