    ...
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form action="{{ route('register') }}" method="POST" class="login100-form validate-form">
                ...
                <div class="wrap-input100 validate-input m-b-18" data-validate="تایید کلمه عبور ضروریست">
                    <span class="label-input100">تایید کلمه عبور</span>
                    <input class="input100" type="password" name="password_confirmation" style="text-align: right" placeholder="...تایید کلمه عبور خود را وارد کنید">
                    <span class="focus-input100"></span>
                </div>
